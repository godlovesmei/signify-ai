...
function TrustStrip() {
  ...
  const localizedTrustItems = t.raw("trust") as string[];
        ...
        <Reveal delay={120} variant="clip">
          <div className="signify-marquee text-[12px] font-medium tracking-[0.08em] uppercase text-[var(--ink-secondary)]">
            <div className="signify-marquee-track" aria-hidden="true">
              {[...localizedTrustItems, ...localizedTrustItems].map((item, index) => (
  ...
  const products = [
    {
      ...
      body: t("translateBody"),
      href: "/translate",
      checks: [t("checks.realtime"), t("checks.buffer"), t("checks.export")],
    },
    {
      title: t("practiceTitle"),
      body: t("practiceBody"),
      href: "/practice",
      checks: [t("checks.hold"), t("checks.overlays"), t("checks.accuracy")],
    },
    {
      title: t("researchTitle"),
      body: t("researchBody"),
      href: "/research",
      checks: [t("checks.readable"), t("checks.limits"), t("checks.context")],
    },
  ];
